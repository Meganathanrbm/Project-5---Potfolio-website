    ...
    <section id="Skills" className="app">
      <div className="row skills-row">
        <div className="skill-top">
          <h1 data-aos="fade-right" className="sm:text-4xl text-3xl dark:text-white text-black capitalize">
        ...
        <div className=" flex-col">
          {skills.map((item, i) => (    //for skills title
            <div className="sm:my-6 my-4" key={i}>
              <h4 data-aos="fade-up" className="sm:text-2xl my-1 text-xl font-medium capitalize text-[#176B87] dark:text-[#EEF5FF]">{item.title}</h4>
              <div className="flex flex-wrap">
                {item.skills.map((skill, j) => (  // for indivudual skills and name
