      ...
      <div className="flex flex-col lg:flex-row">
        <div className="flex-1">
          <div className="about-content">
            <h3 data-aos="fade-right" className="text-blue-500 h3 my-2">Discover</h3>
            <h1 data-aos="fade-right" className="sm:text-4xl text-3xl dark:text-white text-black">About Me</h1>
            <div className="flex-1 center">
              <div data-aos="fade-up" className="w-[270px] sm:w-[300px] my-4 lg:w-[400px] h-auto rounded-full overflow-hidden border-4 border-slate-500 shadow-md shadow-gray-300">
                <img
            ...
            <p data-aos="fade-up" className="para py-2">
              Hello! I'm Meganathan, a 21-year-old web developer specializing in
        ...
        <div className="flex-1 center md:mt-0 mt-6">
          <div data-aos="fade-left"  className="timeline-area sm:pr-[20px] pl-[30px] w-[95%] sm:w-[75%] border-l-[5px] border-[#ccc]">
